...
As an alternative to .peek(), we have the untracked function which receives a function as an argument and returns the outcome of the function. In untracked you can reference any signal with .value without creating a subscription. This can come in handy when you have a reusable function that accesses .value or you need to access more than 1 signal.
