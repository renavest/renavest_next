/**
 * Partnerships Feature Type Definitions
 *
 * This file contains all TypeScript type definitions used throughout
 * the partnerships feature, providing a centralized type system for better
...
/**
 * Represents a step in the partnership journey/onboarding flow
...
export type JourneyStepData = {
  ...
  bg: string;
  /** Optional partnership insight text for business impact */
  hrInsight?: string;
  /** Optional main image URL for visual representation */
  image?: string;
  /** Optional partner image URL for personalization */
...
/**
 * Represents different types of partnerships available
 */
...
/**
 * Represents a partnership opportunity
 */
export type PartnershipOpportunity = {
  ...
  /** Display name */
  name: string;
  /** Display value (e.g., "Revenue sharing model") */
  value: string;
...
/**
 * Countdown timer state for partnership pilot banner
 */
...
/**
 * PostHog tracking context for partnership events
 */
...
/**
 * Navigation click tracking data for partnerships
 */
...
/**
 * Section view tracking data for partnerships
 */
