...
function BusinessImpactSection() {
  ...
  return (
    <section id='business-impact' className='w-full py-24 bg-white'>
      <div
        ref={sectionRef}
      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-10'>
          ...
          <div className='flex flex-col h-full bg-white rounded-3xl p-10 shadow-md hover:shadow-xl transition-shadow duration-500 group'>
            ...
            <p className='text-gray-600 mt-auto'>
              Financial therapy gives your people the confidence to use all the resources you offer.
              When support feels real, benefits get used—and your investment pays off.
            </p>
          </div>
        </div>
      </div>
